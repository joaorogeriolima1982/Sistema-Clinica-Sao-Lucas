...
import service.ServiceTelaEditarPaciente;
...
public class TelaEditarPaciente extends JFrame{
    ...
    ServiceTelaEditarPaciente servicetelaeditarpaciente = new ServiceTelaEditarPaciente();
    ServiceValidarCpfEmailTelefone validar = new ServiceValidarCpfEmailTelefone();

    public TelaEditarPaciente(String id, String nome, String cpf, String telefone, String email, TabelaPaciente tabelapaciente) {
        this.id = id;
        this.nome = nome;
        this.cpf = cpf;
	...
	contentPane.setLayout(null);
        ...
        JLabel lblTitulo = new JLabel("Editar Pacientes");
	...
	contentPane.add(btnCancelar);
        ...
        dadosPaciente(txtNome, txtCpf, txtEmail, txtTelefone);
        
        salvarPacienteEditado(tabelapaciente, btnSalvar, txtCpf, txtTelefone, txtEmail, txtNome);
    ...
    private void dadosPaciente(JTextField txtNome, JTextField txtCpf, JTextField txtEmail, JTextField txtTelefone){
     ...
     private void salvarPacienteEditado(TabelaPaciente tabelapaciente, JButton btnSalvar, JTextField txtCpf, JTextField txtTelefone, JTextField txtEmail, JTextField txtNome){
		...
		boolean validar1 = validar.validarCpf(cpff);
	        ...
	        JOptionPane.showMessageDialog(null, "Preencha o campo Nome", "ATENÇÃO", JOptionPane.ERROR_MESSAGE);
                ...
                servicetelaeditarpaciente.atualizarPaciente(daotelapaciente, idd, nome, cpf, telefone, email, tabelapaciente);
                dispose();
