...
import service.ServiceTelaNovoMedico;
 ...
 */
public class TelaNovoMedico extends JFrame{
    private static final long serialVersionUID = 1L;
    DaoTelaMedico daotelamedico = new DaoTelaMedico();
    ServiceTelaNovoMedico servicetelanovomedico = new ServiceTelaNovoMedico();
    ServiceValidarCpfEmailTelefone validar = new ServiceValidarCpfEmailTelefone();

    public TelaNovoMedico(TabelaMedico tabelamedico){
        setResizable(false);
	...
	contentPane.add(txtEmail);
        ...
        lblEspecialidade.setBounds(200, 223, 130, 27);
        contentPane.add(lblEspecialidade);
        
        JTextField txtEspecialidade = new JTextField();
        txtEspecialidade.setBounds(200, 250, 258, 27);
	...
	contentPane.add(btnCancelar);
        ...
        salvarMedico(tabelamedico, btnSalvar, txtTelefone, txtEmail, txtNome, txtCrm, txtEspecialidade);
        
        cancelar(btnCancelar);
    }
    
    private void salvarMedico(TabelaMedico tabelamedico, JButton btnSalvar, JTextField txtTelefone, JTextField txtEmail, JTextField txtNome, JTextField txtCrm, JTextField txtEspecialidade){
        btnSalvar.addActionListener(e -> {
	      ...
	      JOptionPane.showMessageDialog(null, "Preencha o campo Nome.", "ATENÇÃO", JOptionPane.ERROR_MESSAGE);
              ...
              if(servicetelanovomedico.adicionarMedico(daotelamedico, nome, crm, especialidade, telefone, email, tabelamedico)){
                  dispose();
                  JOptionPane.showMessageDialog(null, "Médico cadastrado com sucesso!", "SUCESSO", JOptionPane.INFORMATION_MESSAGE);
              }else{
                  JOptionPane.showMessageDialog(null, "O CRM informado já está cadastrado.", "ATENÇÃO", JOptionPane.ERROR_MESSAGE);
              }
